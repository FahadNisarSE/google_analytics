...
export default NuxtAuthHandler({
  ...
  providers: [
    ...
    GoogleProvider.default({
      ...
      clientSecret:
        process.env.GOOGLE_CLIENT_SECRET || "enter-your-client-secret-here",
      authorization: {
        params: {
          scope:
            "openid email profile https://www.googleapis.com/auth/webmasters https://www.googleapis.com/auth/analytics.readonly",
        },
      },
    }),
    // @ts-expect-error You need to use .default here for it to work during SSR. May be fixed via Vite at some point
